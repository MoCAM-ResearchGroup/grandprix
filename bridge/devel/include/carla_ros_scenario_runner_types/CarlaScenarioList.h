...
struct CarlaScenarioList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::carla_ros_scenario_runner_types::CarlaScenario_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::carla_ros_scenario_runner_types::CarlaScenario_<ContainerAllocator> >> _scenarios_type;
